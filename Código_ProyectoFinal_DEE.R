...
crear_mapa_bivariado <- function(df, var1, var2, nombre1, nombre2, titulo = NULL) {
  ...
  mapa <- ggplot(df_clasificado) +
    ...
    labs(title = if (!is.null(titulo)) titulo else NULL) +
    theme_minimal() +
...
crear_mapa_bivariado(ccaa_bivariado, "valor_gasto", "valor_esperanza", "Gasto", "Esperanza", titulo = "Gasto sanitario + Esperanza de vida")
crear_mapa_bivariado(ccaa_bivariado, "valor_gasto", "valor_tiempo", "Gasto", "Tiempo", titulo = "Gasto sanitario + Tiempo de espera")
crear_mapa_bivariado(ccaa_bivariado, "valor_medicos", "valor_esperanza", "Médicos", "Esperanza", titulo = "Médicos + Esperanza de vida")
crear_mapa_bivariado(ccaa_bivariado, "valor_medicos", "valor_tiempo", "Médicos", "Tiempo", titulo = "Médicos + Tiempo de espera")
